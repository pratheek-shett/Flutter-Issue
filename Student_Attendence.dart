...
class _StudentAtState extends State<StudentAt> {
  ...
  Future<void> Attendence() async {          //This Get is Used in to get List in Page 
    try {
  ...
  Future<void> fetchData() async {  //This api is used to get event names in drop down in the add student
    try {
      final prefs = await SharedPreferences.getInstance();
      String? token = prefs.getString('token');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(  // This Button adds Students with some placeholders
        onPressed: () {
          showDialog(
            context: context,
            builder: (context) {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: IconButton(
                                                ...
                                                onPressed: () {}, // Here I need to display the same type of dialog as student adding its implimented in EditDialog.dart
                                                color: Colors.white,
                                                iconSize: 20,
                                              ),
                                            ),
                                    ...
                                    Padding(                                       // These values should be shown in that editing dialog to edit 
                                      padding: EdgeInsets.symmetric(vertical: 5.0),
                                      child: Text(
                                        'Class: ${event['class'] ?? ''}',
                                        style: TextStyle(
